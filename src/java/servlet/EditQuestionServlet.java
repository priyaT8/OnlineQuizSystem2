...
public class EditQuestionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "UPDATE questions SET paper_id=?, question=?, option_a=?, option_b=?, option_c=?, option_d=?, correct_answer=?, question_type=? WHERE q_id=?";
            ...
            ps.setInt(9, qId);
            ps.executeUpdate();
            response.sendRedirect("admindashboard.jsp?msg=Question updated successfully!");
        } catch (Exception e) {
